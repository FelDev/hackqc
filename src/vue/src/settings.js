...
const settings = {
  ...
  BASE_URL: ((env) => {
    ...
    switch (env) {
      // local
      case 'development':
        return 'https://slhackers.kffein';
      // build for prod
      case 'production':
      default:
        // return 'https://slhackers.com';
        return 'http://slhackers.dev.kffein.work';
    }
  ...
  API_URL: null,
  // API_URL: 'https://slhackers.kffein',

  /** @argument {Array} cookies - list of cookies names, please keep locale */
  cookies: {
    locale: 'slhackers_locale', // not sure about this?
  },
